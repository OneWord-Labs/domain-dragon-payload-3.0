// Prompts
// export const TOPIC_PROMPT = `Topic: Falcon LLM`

// export const OUTLINE_PROMPT = `# What is Falcon LLM?
...
export const AGENT_SYSTEM_PROMPT = `You are a blog writing assistant. Your job is to write a blog about the given topic.
...
export const BLOG_SECTION_AGENT_SYSTEM_PROMPT = `You are a blog writing assistant. Your job is to first research the topic and then the blog section and
...
export const RQNA_SYSTEM_PROMPT = `You are a blog writing assistant. Your job is to write a blog about the given topic.
...
export const RECURRENT_RQNA_SYSTEM_PROMPT = `You are a blog writing assistant. Your job is to write only the content of the specified blog section.
...
export const REWRITE_PROMPT = `You are a skilled blog writer who is able to produce high quality blog posts. Keep the same sections and headings.
...
export const SUMMARIZE_PROMPT = `Write a detailed summary that captures all relevant information of the following text:
